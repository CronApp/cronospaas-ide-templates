	...
	<div ng-hide="${model.dataSourceName}.inserting || ${model.dataSourceName}.editing"
	  ...
	  <#list model.formFields as field>
		...
		<div data-component="crn-search" id="crn-search-${field.name}-${model.random}">
            ...
            xattr-size="" xattr-fullsize="" xattr-theme="btn-default" crn-datasource="${model.dataSourceName}"
            ng-click="" id="crn-button-search">
        ...
        <div crn-datasource="${model.dataSourceName}" class=""
            ...
            <div class="component-holder ng-binding ng-scope" data-component="crn-ion-list" id="crn-ion-list-main">
                <cron-list ng-model="vars.cronlist${model.dataSourceName}" id="ion-list-main"
                           options="${model.getMobileList(model.dataSourceName, model.dataSourceName, field)}"
                           class="" style="">
                </cron-list>
            </div>
        </div>

<div class="component-holder ng-binding ng-scope <#if !(menuPosition??) || menuPosition == "Horizontal">crn-navigator-horizontal<#else>crn-navigator-vertical</#if>" data-component="crn-navbar" id="main-nav-bar" tabindex="-1">
  <nav class="navbar navbar-default">
        <ul aria-label="{{'DirectAccess' | translate}}" class="main-access" tabindex="-1">
            <li><a crn-anchor="main-view" href="javascript:void(0);" class="main-nav-link"
                    alt="{{'MainContent' | translate}}">{{'MainContent' | translate}}</a> </li>
            <li><a crn-anchor="main-nav-bar" href="javascript:void(0);" class="main-nav-link"
                    alt="{{'MainMenu' | translate}}">{{'MainMenu' | translate}}</a> </li>
        </ul>
        <div class="container-fluid">
            <div class="navbar-header">

                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#navbar, #navbar2" aria-expanded="false" aria-controls="navbar"> <span
                ...
                <a class="component-holder ng-binding ng-scope navbar-brand" data-component="crn-image"
                    ng-click="cronapi.screen.changeView('#/home', [])">
                    <img alt="{{'Home.view.Home' | translate}}"
                        src="node_modules/cronapp-framework-js/dist/img/logo.svg" style="width:101px; margin-top:-4px"
                        id="crn-navbar-logo" data-component="crn-image">
                </a>

                <#if !(menuPosition??) || menuPosition=="Vertical">
                    <div>
                        <a href="" class="nav-button buttons-password "
                            title="{{'Home.view.ChangePassword' | translate}}"
                            alt="{{'Home.view.ChangePassword' | translate}}"
                            ng-click="cronapi.screen.showModal('modalPassword')" data-component="crn-anchor">
                        ...
                        <a ng-click="logout()" href="" class="nav-button buttons-logout"
                            title="{{'Home.view.Logout' | translate}}" alt="{{'Home.view.Logout' | translate}}"
                            data-component="crn-anchor">
                    ...
                    <#if (customMenu??)>
                        <#list customMenu?keys as key>
                            <#assign items=customMenu[key]>
                                <li class="dropdown component-holder" data-component="crn-menu-item"> <a
                                        class="dropdown-toggle" data-toggle="dropdown" role="button"
                                        aria-haspopup="true" aria-expanded="false" aria-label="${key}"> <i class=""></i>
                                        <span>${key}</span> <span class="caret"></span> </a>
                                    <#if (items??)>
                                        <ul class="dropdown-menu">
                                            <#list items as item>
                                                <li><a href="#/home/logged/${item.name?lower_case}"
                                                        class="component-holder"
                                                        data-component="crn-anchor">${item.realName}</a></li>
                                            </#list>
                                        </ul>
                                    </#if>
                                </li>
            ...
            <#if !(menuPosition??) || menuPosition=="Horizontal">
                <div id="navbar-3" class="navbar-collapse collapse">
                    <div class="nav navbar-nav navbar-right" style="margin-right: 0;">
                        ...
                        <div class="component-holder" data-component="crn-menu-item"
                            style="display: flex; align-items: center;">

                            <a href="" class="nav-button" role="button" title="{{'Home.view.Perfil' | translate}}"
                                alt="{{'Home.view.Perfil' | translate}}" aria-haspopup="true" aria-expanded="false">

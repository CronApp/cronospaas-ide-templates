            ...
            <div class="container-fluid" id="container-fluid">
                <div class="row component-holder login-panel-1" id="component-holder">
                    <div id="responsive-component" class="col-md-9 col-lg-7 col-sm-10  col-xs-11">
                        ...
                        <form class="form-validation ng-pristine ng-valid ng-valid-required" autocomplete="off"
                            ...
                            <img alt="Login" src="node_modules/cronapp-framework-js/img/cronapp-logo-login.png"
                                class="crn-image img-login component-holder" style="object-fit: contain"
                                object-fit="object-fit: contain;" xattr-position="margin-left:auto; margin-right:auto;"
                                data-component="crn-image" id="crn-image-login">
                            ...
                            <#if authentication?lower_case !="sso" && authentication?lower_case !="saml">
                                ...
                                <div class="component-holder ng-binding ng-scope col-xs-12 col-md-12"
                                    data-component="crn-textinput" id="crn-textinput-loginusername">
                                    <div class="form-group">
                                        ...
                                        <input type="text" mask="" mask-placeholder="" ng-required="false"
                                            ng-model="username.value" class="form-control k-textbox"
                                            id="input-login-username" placeholder="" autocomplete="username"
                                ...
                                <div class="component-holder ng-binding ng-scope col-xs-12 col-md-12"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" mask="" mask-placeholder="" ng-required="false"
                                            ng-model="password.value" class="form-control k-textbox"
                    ...
                    <a ng-click="cronapi.screen.showModal('forgotPasswordModal')"
                        class="reset-password cron-link text-right component-holder col-xs-12  col-md-12" target="_self"
                        data-replace="true" data-component="crn-anchor" id="crn-botao-cadastre">{{'ResetPassword' |
                        translate}}
                    </a>
                    ...
                    <#if (authentication?lower_case=="sso" || authentication?lower_case=="saml" ) && (enterprise)!false>
                        ...
                        <div class="component-holder ng-binding ng-scope col-xs-12 col-md-12"
                            data-component="crn-textinput" id="crn-textinput-loginusername">
                            <div class="form-group">
                                <label for="input-login-username">{{'Login.view.Username' |
                                    translate}}</label>
                                <input type="text" mask="" mask-placeholder="" ng-required="false"
                                    ng-model="username.value" class="form-control k-textbox"
                                    id="input-login-username" placeholder="" autocomplete="username"
                    ...
                    <#else>
                        ...
                        <div class="component-holder ng-scope" data-component="crn-button"
                            ...
                            <button role="button" aria-label="{{'Login.view.Login' | translate}}"
                                ...
                                xattr-fullsize="btn-block" xattr-theme="ry" xattr-disabled=""
                                ...
                                <ul class="list-inline text-left">
                                    <li data-container="true">
                                        <form action="/signin/facebook" method="POST" id="facebook">
                                            ...
                                            <a title="Facebook" role="button"
                                                onclick="document.getElementById('facebook').submit()">
                                    ...
                                    <li data-container="true">
                                        <form action="/signin/github" method="POST" id="github">
                                            <input type="hidden" name="csrf_token"
                                                value="CIwNZNlR4XbisJF39I8yWnWX9wX4WFoz" />
                                            <input type="hidden" name="scope" value="email,public_profile">
                                            <a title="GitHub" role="button"
                                                onclick="document.getElementById('github').submit()">
                                    ...
                                    <li data-container="true">
                                        <form action="/signin/linkedin" method="POST" id="linkedin">
                                            ...
                                            <a title="LinkedIn" role="button"
                                                onclick="document.getElementById('linkedin').submit()">
                ...
                <div class="modalPassword">
                    <div class="component-holder ng-scope  col-md-2" data-component="crn-button" id="crn-button-save">
                        <button class="btn k-button crnCSS-default btn-primary" type="submit"
                            ng-click="cronapi.client('js.blockly.UserControl.resetPassword').names('7afdf898').run(forgotPasswordEmail.value)"
                            xattr-fullsize="" aria-label="{{'Save' | translate}}" xattr-theme="btn-primary"
                            xattr-disabled="" ng-disabled="form.$invalid || vm.dataLoading">

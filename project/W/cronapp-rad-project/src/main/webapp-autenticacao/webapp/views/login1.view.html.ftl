<div class="center-content">
    <div class="bg-login bg-login1" id="bg-login1">
                    ...
                    <div class="row component-holder login-panel-1" id="component-holder">
                        <div id="responsive-component" class="col-md-9 col-lg-7 col-sm-10  col-xs-11">
                            ...
                            <form class="form-validation ng-pristine ng-valid ng-valid-required" autocomplete="off" name="form" ng-submit="login()" role="form">
                                ...
                                <img alt="Login" src="node_modules/cronapp-framework-js/img/cronapp-logo-login.png" class="crn-image img-login component-holder" style="object-fit: contain" object-fit="object-fit: contain;" xattr-position="margin-left:auto; margin-right:auto;" data-component="crn-image"
                                    id="crn-image-login">
                                ...
                                <#if authentication?lower_case !="sso" && authentication?lower_case !="saml">
                                    ...
                                    <div class="component-holder ng-binding ng-scope col-xs-12 col-md-12" data-component="crn-textinput" id="crn-textinput-loginpassword"
                                        style="margin-bottom: 1px;">
                                        <div class="form-group">
                                            <label for="input-login-password">{{'Login.view.Password' | translate}}</label>
                                            <input type="password" mask="" mask-placeholder="" ng-required="false" ng-model="password.value" class="form-control k-textbox"
                                                id="input-login-password" autocomplete="current-password" placeholder="">
                                        </div>
                                    </div>
                                ...
                                <a ng-click="cronapi.screen.showModal('forgotPasswordModal')" class="reset-password cron-link text-right component-holder col-xs-12  col-md-12"
                                    target="_self" data-replace="true" data-component="crn-anchor" id="crn-botao-cadastre">{{'ResetPassword' |  translate}}  </a>


                                <#if (authentication?lower_case=="sso" || authentication?lower_case=="saml" ) &&
                                    (enterprise)!false>
                                    <a role="button" aria-label="{{'Login.view.Login' | translate}}" href="#" class="btn k-button btn-login btn-block" id="crn-button-login-authentication" target="_self" data-replace="true" data-component="crn-anchor" ng-click="redirectToLogin()">
                                    ...
                                    <#else>
                                        <div class="component-holder ng-scope" data-component="crn-button" id="crn-button-login">
                                            <button role="button" aria-label="{{'Login.view.Login' | translate}}" class="btn k-button btn-login btn-block" type="submit"
                                                ng-disabled="form.$invalid || vm.dataLoading" ng-click="" xattr-size="" xattr-fullsize="btn-block" xattr-theme="" xattr-disabled="" data-component="crn-button"><i class="" icon-theme=""></i><span>{{"Login.view.Login" | translate}}
                                                </span>
                                            </button>
                                        </div>
                        ...
                        <#if social?? && social?lower_case=="sim">
                            <div id="social-login">
                                <p data-component="crn-simple-text" class="component-holder col-xs-12 col-md-12" id="crn-simple-text-login-social">Ou continue com</p>
            ...
            <div class="modal-footer">
                <div class="component-holder ng-scope col-md-12" data-component="crn-button" id="crn-button-save">
                    <button class="btn k-button btn-primary" type="submit"
                        ng-click="cronapi.client('js.blockly.UserControl.resetPassword').names('7afdf898').run(forgotPasswordEmail.value)" xattr-fullsize="" aria-label="{{'Save' | translate}}" xattr-theme="btn-primary" xattr-disabled="" ng-disabled="form.$invalid || vm.dataLoading">
